...
export type JourneyMilestone = { id: string; regionId: string; regionOrder: number; alias: string; kind: 'presentation' | 'question' | 'consolidation' | 'vote'; sectionTitle: string; title: string; metric: number; uniqueContributors: number; topics: string[]; branches: JourneyBranch[] }
